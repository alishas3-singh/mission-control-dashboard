        ...
        yesNode: {
            ...
            yesNode: {
                ...
                yesNode: {
                    id: '8',
                    question: '',
                    outcome: '🚁 Helicopter Direct — Fastest Route',
                    priority: 'high',
                ...
                noNode: {
                    id: '9',
                    question: '',
                    outcome: '🚑 Ambulance Priority — Sheltered Route',
                    priority: 'high',
                    isActivePath: severityMet && trafficLow && !weatherGood,
                },
            },
            noNode: {
                ...
                yesNode: {
                    id: '10',
                    question: '',
                    outcome: '🚁 Helicopter Emergency — Bypass Traffic',
                    priority: 'high',
                ...
                noNode: {
                    id: '11',
                    question: '',
                    outcome: '🚑 Ambulance Alternate — Highway Reroute',
                    priority: 'high',
                    isActivePath: severityMet && !trafficLow && !trafficVeryHigh,
                },
            },
        ...
        noNode: {
            ...
            yesNode: {
                ...
                yesNode: {
                    id: '12',
                    question: '',
                    outcome: '🛸 Drone Delivery — Standard Route',
                    priority: 'medium',
                ...
                noNode: {
                    id: '13',
                    question: '',
                    outcome: '🚑 Ambulance Standard — Avoid Congestion',
                    priority: 'medium',
                    isActivePath: !severityMet && weatherGood && !trafficLow,
                },
            },
            noNode: {
                ...
                yesNode: {
                    id: '14',
                    question: '',
                    outcome: '🚑 Ambulance Cautious — Weather-Safe Route',
                    priority: 'low',
                ...
                noNode: {
                    id: '15',
                    question: '',
                    outcome: '🚑 Ambulance Normal — Moderate Conditions',
                    priority: 'medium',
                    isActivePath: !severityMet && !weatherGood && !weatherSevere,
                },
            },
